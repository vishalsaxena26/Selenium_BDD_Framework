...
public class LoginStepDefinitions {
    ...
    public void i_have_entered_a_valid_username_and_password() throws IOException {
        loginPage.enterEmail(ConfigReader.getProperty("loginId"));
        loginPage.enterPassword(ConfigReader.getProperty("pwd"));
    }
